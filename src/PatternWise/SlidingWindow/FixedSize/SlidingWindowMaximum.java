...
public class SlidingWindowMaximum {
    // this is a valid solution but it will give you TLE as time complexity is n*k
    // and if k ->n then n^2 which is bad
    ...
    public int[] maxSlidingWindow(int[] nums, int k) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            // Remove elements from the back of the deque while they are smaller than the
            // current element
            ...
            // When we have processed at least `k` elements, the front of the deque is the
            // max for this window
            if (i >= k - 1) {
